...
window.MathJax = {
  ...
  chtml: {
    font: 'mathjax-newcm',
    fontURL: 'adv-math-wiki/assets/mathjax-fonts/mathjax-newcm-font/woff-v2',  // 字体文件地址（可换国内源）
    dynamicPrefix: 'adv-math-wiki/assets/mathjax-fonts/mathjax-newcm-font/dynamic',
